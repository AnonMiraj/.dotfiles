...
local function set_component_style(component, component_type)
	if component_type == ComponentType.A then
		component:style(ui.Style():fg(style_a.fg):bg(style_a.bg):bold())
	elseif component_type == ComponentType.B then
		component:style(ui.Style():fg(style_b.fg):bg(style_b.bg))
	else
		component:style(ui.Style():fg(style_c.fg):bg(style_c.bg))
	end
end
